...
// This file never mocks @/auth or @/lib/auth/authorize, and route.ts never
// imports them — a normal response here with zero auth setup anywhere is
// itself proof the endpoint doesn't gate on a session.
